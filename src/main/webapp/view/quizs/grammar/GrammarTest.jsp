...
<link rel="stylesheet"
	...
	<link rel="stylesheet"
	href=<c:url value="/assets/css/elementTest.css"/>>
<style>
.circle {
	background: #FFFFFF;
	border-radius: 50%;
		...
		<div class="row">
			<div class="col-md-8">
				<div class="titleReading">
					<h4>Practice Full Test TOEIC Grammar</h4>
				</div>
				<div class="question">
					<p id="question"></p>
				</div>
					...
					<div class="result">
						<ul>
							<li><input type="radio" name="cau" id="cauhoi1"
								...
								for="cauhoi1" class="cauhoi1"> <strong>A.</strong> <sapn id="cau1" ></sapn>
							</label></li>
							<li><input type="radio" name="cau" value="B" id="cauhoi2"
								onclick="handleClick(this);"> <label for="cauhoi2" class="cauhoi2">
									<strong>B.</strong> <sapn id="cau2"></sapn>
							</label></li>
							<li><input type="radio" name="cau" value="C" id="cauhoi3"
								onclick="handleClick(this);"> <label for="cauhoi3" class="cauhoi3"><strong>C.</strong>
									<sapn id="cau3"></sapn> </label></li>
							<li><input type="radio" name="cau" value="D" id="cauhoi4"
								onclick="handleClick(this);"> <label for="cauhoi4" class="cauhoi4"><strong>D.</strong>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="sendKD">
						<p>* Submit your test results here to receive advice from us on your learning path</p>						
					</div>
					<div class="row justify-content-between">
						<div class="col-4">
						...
						<div class="col-4">
							<div class="text-right">
								...
								<button type="button"  onclick="showKQ()" class="btn btn-success rounded">See the answer</button>
							</div>
						</div>
					</div>
...
<script>
         ...
         // thay đổi background khi 1 câu đã được trả lời
            ...
            function nextPage() {
            	// ban đầu chưa gửi đáp án để xem kết quả
