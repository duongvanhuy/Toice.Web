					...
					<div class="row">
						<div class="col-12">
							<div class="section-title">
								<h4 class="m-0 text-uppercase font-weight-bold">TOEIC TEST
									DOCUMENTS</h4>
							</div>
						</div>
						<div class="col-12">
							<ul>
								<li class="py-3"><i
									...
									href="#" class="text-dark">[FULL PDF] 2 20 TOPIC OF
										COMMUNICATION AT WORK</a></li>
								<li class="py-3"><i
									class="fas fa-arrow-alt-circle-right text-success"></i> <a
									href="#" class="text-dark"> Download now the full set of
										ENGLISH VOCABULARY IN USE - Vocabulary for all levels</a></li>
								<li class="py-3"><i
									class="fas fa-arrow-alt-circle-right text-success"></i> <a
									href="#" class="text-dark"> Student gifts: Exclusive
										materials compiled by us</a></li>
								<li class="py-3"><i
									class="fas fa-arrow-alt-circle-right text-success"></i> <a
									href="#" class="text-dark">Complete TOEIC Preparation LC +
										RC Volume 1, 2 {PDF + Audio}</a></li>
								<li class="py-3"><i
									class="fas fa-arrow-alt-circle-right text-success"></i> <a
									href="#" class="text-dark">Bootcamp for the TOEIC -
										Thorough TOEIC preparation materials [PDF + Audio] </a></li>
								<li class="py-3"><i
									class="fas fa-arrow-alt-circle-right text-success"></i> <a
									href="#" class="text-dark">TOEIC preparation materials:
										Very easy TOEIC book</a></li>
							</ul>
						</div>
