<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
   <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href=<c:url value="/assets/css/templatemo-grad-school.css" />>

        <link rel="stylesheet" type="text/css" href=<c:url value="/assets/css/templatemo-grad-school.css" />>
    </head>
    ...
    <body>
                ...
                <div class="col-lg-7 px-0">
                    <div class="owl-carousel main-carousel position-relative">
                        <div class="position-relative overflow-hidden" style="height: 500px;">
                            <img class="img-fluid h-100" style="object-fit: cover;" src=<c:url
                                value="/assets/imgReading/news-800x500-1.jpg" />
                            >
                            <div class="overlay">
                                <div class="mb-2">
                    ...
                    <div class="row mx-0">
                        <div class="col-md-6 px-0">
                            <div class="position-relative overflow-hidden" style="height: 250px;">
                                <img class="img-fluid w-100 h-100" style="object-fit: cover;" src=<c:url
                                    value="/assets/imgReading/news-700x435-1.jpg" />
                                >
                                <div class="overlay">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                        ...
                        <div class="col-md-6 px-0">
                            <div class="position-relative overflow-hidden" style="height: 250px;">
                                <img class="img-fluid w-100 h-100" style="object-fit: cover;" src=<c:url
                                    value="/assets/imgReading/news-700x435-2.jpg" />
                                >
                                <div class="overlay">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" style="object-fit: cover;" src=<c:url
                                        value="/assets/imgReading/news-700x435-1.jpg" />
                                    >
                                    ...
                                    <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                        <div class="d-flex align-items-center">
                                            <img class="rounded-circle mr-2" width="25" height="25" alt="" src=<c:url
                                                value="/assets/imgReading/user.jpg" />
                                            >
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" style="object-fit: cover;" href=<c:url
                                        value="/assets/imgReading/news-700x435-2.jpg" />
                                    >
                                    <div class="bg-white border border-top-0 p-4">
                                        <div class="mb-2">
                                    ...
                                    <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                        <div class="d-flex align-items-center">
                                            <img class="rounded-circle mr-2" width="25" height="25" alt="" href=<c:url
                                                value="/assets/imgReading/user.jpg" />
                                            >
                                            <small>John Doe</small>
                                        </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                <a href=""><img class="img-fluid w-100" alt="" src=<c:url
                                        value="/assets/imgReading/ads.png" />
                                    ></a>
                            </div>
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                    <img class="img-fluid" alt="" src=<c:url
                            ...
                            <div class="col-lg-12 mb-3">
                                <a href=""><img class="img-fluid w-100" alt="" src=<c:url
                                        value="/assets/imgReading/ads-728x90.png" />></a>
                            </div>
                            <div class="col-lg-12">
                                <div class="row news-lg mx-0 mb-3">
                                    <div class="col-md-6 h-100 px-0">
                                        <img class="img-fluid h-100" src=<c:url
                                            value="/assets/imgReading/news-700x435-5.jpg" />
                                    ...
                                    <div class="col-md-6 d-flex flex-column border bg-white h-100 px-0">
                                        ...
                                        <div class="d-flex justify-content-between bg-white border-top mt-auto p-4">
                                            <div class="d-flex align-items-center">
                                                <img class="rounded-circle mr-2" width="25" height="25" alt=""
                                                    src=<c:url value="/assets/imgReading/user.jpg" />
                                                >
                                                <small>John Doe</small>
                                            </div>
                                            <div class="d-flex align-items-center">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="bg-white text-center border border-top-0 p-3">
                                <a href=""><img class="img-fluid" alt="" src=<c:url
                                        value="/assets/imgReading/news-800x500-2.jpg" />
                                    ></a>
                            </div>
                        </div>
                        <!-- Ads End -->
        ...
        <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
            <p class="m-0 text-center"> <i class="fa fa-copyright"></i> Copyright 2020 by Grad School
